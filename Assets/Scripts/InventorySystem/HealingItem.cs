...
namespace CuscuzBane.InventorySystem
{
    public class HealingItem : Item
    {
        ...
        public HealingItem(string name, Sprite sprite, Vector3 position, GameObject original, float healAmount) : base(GenericItemType.Instance)
        {
            this.name = name;
